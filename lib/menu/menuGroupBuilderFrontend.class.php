...
class menuGroupBuilderFrontend extends menuGroupBuilder
{
  ...
  protected function build()
  {
    ...
    if ($madbConfig->get("distribution") == "mageia")
    {
      ...
      $items[] = $this->createItem('Release blockers for Mga 8', 'tools/blockers');
      $items[] = $this->createItem('Intended for Mga 8', 'tools/milestone');
      $items[] = $this->createItem('High priority for Mga 8', 'tools/highPriority');
    }

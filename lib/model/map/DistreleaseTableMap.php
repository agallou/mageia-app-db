...
/**
 * This class defines the structure of the 'distrelease' table.
 *
 *
 *
 ...
 */
class DistreleaseTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.DistreleaseTableMap';
	...
	{
	  // attributes
		$this->setName('distrelease');
		$this->setPhpName('Distrelease');
		$this->setClassname('Distrelease');
		$this->setPackage('lib.model');
		$this->setUseIdGenerator(true);
		$this->setPrimaryKeyMethodInfo('distrelease_id_seq');
		// columns

...
class LanguageTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.LanguageTableMap';
	...
	{
    $this->addRelation('PackageDescription', 'PackageDescription', RelationMap::ONE_TO_MANY, array('id' => 'language_id', ), null, null);

...
/**
 * Base class that represents a row from the 'user_comments_software_request' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseUserCommentsSoftwareRequest extends BaseObject  implements Persistent {
	 ...
	 * @var        UserCommentsSoftwareRequestPeer
	 */
	 ...
	 * @return     UserCommentsSoftwareRequest The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = UserCommentsSoftwareRequestPeer::ID;
		}
	...
	public function setUserIduser($v)
	{
		...
		if ($this->user_iduser !== $v) {
			$this->user_iduser = $v;
			$this->modifiedColumns[] = UserCommentsSoftwareRequestPeer::USER_IDUSER;
		}
	...
	public function setSoftwareRequestId($v)
	{
		...
		if ($this->software_request_id !== $v) {
			...
			$this->modifiedColumns[] = UserCommentsSoftwareRequestPeer::SOFTWARE_REQUEST_ID;
		}
	...
	public function setComment($v)
	{
		...
		if ($this->comment !== $v) {
			$this->comment = $v;
			$this->modifiedColumns[] = UserCommentsSoftwareRequestPeer::COMMENT;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = UserCommentsSoftwareRequestPeer::CREATED_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->software_request_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 5; // 5 = UserCommentsSoftwareRequestPeer::NUM_COLUMNS - UserCommentsSoftwareRequestPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating UserCommentsSoftwareRequest object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = UserCommentsSoftwareRequestPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = UserCommentsSoftwareRequestPeer::doInsert($this, $con);
					...
					$affectedRows += UserCommentsSoftwareRequestPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = UserCommentsSoftwareRequestPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = UserCommentsSoftwareRequestPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = UserCommentsSoftwareRequestPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getUserIduser(),
			$keys[2] => $this->getSoftwareRequestId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setSoftwareRequestId($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserCommentsSoftwareRequestPeer::ID)) $criteria->add(UserCommentsSoftwareRequestPeer::ID, $this->id);
		if ($this->isColumnModified(UserCommentsSoftwareRequestPeer::USER_IDUSER)) $criteria->add(UserCommentsSoftwareRequestPeer::USER_IDUSER, $this->user_iduser);
		if ($this->isColumnModified(UserCommentsSoftwareRequestPeer::SOFTWARE_REQUEST_ID)) $criteria->add(UserCommentsSoftwareRequestPeer::SOFTWARE_REQUEST_ID, $this->software_request_id);
		if ($this->isColumnModified(UserCommentsSoftwareRequestPeer::COMMENT)) $criteria->add(UserCommentsSoftwareRequestPeer::COMMENT, $this->comment);
		if ($this->isColumnModified(UserCommentsSoftwareRequestPeer::CREATED_AT)) $criteria->add(UserCommentsSoftwareRequestPeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(UserCommentsSoftwareRequestPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of UserCommentsSoftwareRequest (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     UserCommentsSoftwareRequest Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     UserCommentsSoftwareRequestPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new UserCommentsSoftwareRequestPeer();
		}
		return self::$peer;
	}
	...
	public function setUser(User $v = null)
	{
		...
		if ($v !== null) {
			$v->addUserCommentsSoftwareRequest($this);
		}
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->user_iduser !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUser->addUserCommentsSoftwareRequests($this);
			 */
		}
		return $this->aUser;
	}
	...
	public function getSoftwareRequest(PropelPDO $con = null)
	{
		if ($this->aSoftwareRequest === null && ($this->software_request_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aSoftwareRequest->addUserCommentsSoftwareRequests($this);
			 */
		}

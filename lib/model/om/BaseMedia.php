...
abstract class BaseMedia extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 1; // 1 = MediaPeer::NUM_COLUMNS - MediaPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * related Rpms from storage. If this Media is new, it will return
		...
		if ($this->collRpms === null) {
			if ($this->isNew()) {
			   $this->collRpms = array();
				...
				$criteria->add(RpmPeer::MEDIA_IDMEDIA, $this->idmedia);
